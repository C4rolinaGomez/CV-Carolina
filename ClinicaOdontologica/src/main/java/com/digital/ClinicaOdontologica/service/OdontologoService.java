...
public class OdontologoService {
    ...
    public Optional<Odontologo> buscarOdontologoPorNombre(String nombre){
    ...
    public void eliminarOdontologo(Long id){
        ...
        if(!odontologoEliminar.filter(odontologo -> odontologo.getId() != null && odontologo.getId() > 1).isPresent()){
            LOGGER.error("Por favor ingrese un id valido");
            return;
        }
        LOGGER.info("Se ha eliminado el Odontologo correctamente");
